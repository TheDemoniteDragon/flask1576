...
@app.route("/")
def home():
    return '<h1>INI HALAMAN UTAMA</h1><a href="/random_facts">Klik untuk melihat fakta</a><br><br><a href="/random_ways">Klik untuk melihat cara mencegah kecanduan internet</a>'
